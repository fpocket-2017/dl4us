...
本コーパスには、国際出願日が2006年1月1日から2013年12月31日の国際出願について、1ヶ月ごとに約1000件を無作為抽出した国際出願の特許請求の範囲のテキストデータから構成されています。本コーパスに含まれるテキストデータは、和文についてはMeCab、英文についてはNLTKのTokenizerを使用して、トークナイズ処理をしてあります。
...
今後は、知財実務に携わりながら、知財実務における深層学習の利活用に関する研究・開発を行う予定です。研究・開発によって得られた知見は、GitHubや[ブログ](https://fpocket-ipml.blogspot.jp/)などを通じて共有していきたいと考えています。何らかの形で皆様のお役に立てば幸いです。
